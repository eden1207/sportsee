...
export default function UserTodayScore({ score }) {
    ...
    return (
        <ResponsiveContainer className='UserTodayScore' width={245} height='88%'>
            <PieChart>
                <Legend content={<CustomLegend score={score} />} verticalAlign="top" />
                <Pie data={data} stroke='none' startAngle={90} endAngle={450}  cornerRadius={100} dataKey="value" cx="50%" cy="50%" innerRadius="80%" outerRadius="90%" fill="#ff0000" >
                    {
